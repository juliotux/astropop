...
# Important: Stolen from astropy's repo, since tests should match a lot
# Modified to astropop's


# TODO: Handle the uncertainties
...
from astropop.ccddata import CCDData
