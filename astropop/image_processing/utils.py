...
def combine_bias(image_list, save_file=None,
                 ...
                 mem_limit=1e8, inplace=True, add_keywords={},
...
def combine_dark(image_list, save_file=None,
    ...
    hdus = process_list(process_image, image_list, rebin_size=rebin_size,
                        ...
                        lacosmic_params=lacosmic_params, logger=logger)
